...
public class CarIncomeExpenseActivity extends BaseActivity implements View.OnClickListener {
    private final String TAG = "CarIncomeExpenseActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.car_income_expense_layout);
