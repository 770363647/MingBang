...
import com.mingbang.mingbang.mingbang.adapter.ApproveItemAdapter;
...
public class ApproveActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ApproveItemAdapter adapter = null;
    ...
    private void setRecyclerView() {
        ...
        adapter = new ApproveItemAdapter(data, this);
        adapter.setOnItemClickListener(new ApproveItemAdapter.OnItemClickListener() {
            @Override
