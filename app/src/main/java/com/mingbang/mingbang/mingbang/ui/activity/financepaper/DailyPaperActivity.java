package com.mingbang.mingbang.mingbang.ui.activity.financepaper;
...
public class DailyPaperActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daily_paper_layout);
        init();
    }
    ...
    private void getAxisPoints() {
        float[] weather = {18f, 23f, 12f, 15f, 10f, 7f, 6f, 14f, 19f, 24f, 18f};
